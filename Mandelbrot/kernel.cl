...
__kernel void ckMandelbrotInterop(write_only image2d_t tex,
      float scale, float Ro, float Io){
    ushort x = get_global_id(0),  y = get_global_id(1);
    ...
    if (n == 1024) col = (uchar4)(0, 0, 0, 255);
    else{
      int c = (int)((n % 64)*24.0f);
      col = (uchar4)(
       iClamp( (int)abs(c - 768) - 384 ),
    ...
    float4 tmp = (float4)(col.x, col.y, col.z, col.w);
    tmp.x /= 255; tmp.y /= 255;
    tmp.z /= 255; tmp.w /= 255;

    write_imagef(tex, (int2)(x,y), tmp);
  }

  __kernel void ckManZ2deInterop(write_only image2d_t tex,
      float scale, float Ro, float Io){
    ushort x = get_global_id(0),  y = get_global_id(1);
    float Cr = (x - 256) * scale + Ro,  Ci = -(y - 256) * scale + Io;
    float I=0.0f, R=0.0f,  I2=0.0f, R2=0.0f, Dr=0.0f, Di=0.0f, D;
  ...
  __kernel void ckManZ2smInterop(write_only image2d_t tex,
      float scale, float Ro, float Io){
    ushort x = get_global_id(0),  y = get_global_id(1);
    float Cr = (x - 256) * scale + Ro,  Ci = -(y - 256) * scale + Io;
    float I=0.0f, R=0.0f,  I2=0.0f, R2=0.0f;
  ...
  __kernel void ckManZ3Interop(write_only image2d_t tex,
      float scale, float Ro, float Io){
    ushort x = get_global_id(0),  y = get_global_id(1);
    float Cr = (x - 256) * scale + Ro,  Ci = -(y - 256) * scale + Io;
    float I=0.0f, R=0.0f,  I2=0.0f, R2=0.0f;
  ...
  __kernel void ckManZ3smInterop(write_only image2d_t tex,
      float scale, float Ro, float Io){
    ushort x = get_global_id(0),  y = get_global_id(1);
    float Cr = (x - 256) * scale + Ro,  Ci = -(y - 256) * scale + Io;
    float I=0.0f, R=0.0f,  I2=0.0f, R2=0.0f;
  ...
  __kernel void ckManZ4Interop(write_only image2d_t tex,
      float scale, float Ro, float Io){
    ushort x = get_global_id(0),  y = get_global_id(1);
    float Cr = (x - 256) * scale + Ro,  Ci = -(y - 256) * scale + Io;
    float I=0.0f, R=0.0f,  I2=0.0f, R2=0.0f, R2_I2, RI=R*I, RI4;
  ...
  __kernel void ckManZ4smInterop(write_only image2d_t tex,
      float scale, float Ro, float Io){
    ushort x = get_global_id(0),  y = get_global_id(1);
    float Cr = (x - 256) * scale + Ro,  Ci = -(y - 256) * scale + Io;
    float I=0.0f, R=0.0f,  I2=0.0f, R2=0.0f, R2_I2, RI=R*I, RI4;
  ...
  __kernel void ckMakinInterop(write_only image2d_t tex,
      float scale, float Ro, float Io){
    ushort x = get_global_id(0),  y = get_global_id(1);
