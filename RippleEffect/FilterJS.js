...
function runRippleJS(inputPixels, outputPixels, t, cx, cy, diag) {
    ...
    var I = function (off) { return [inputPixels[off+0], inputPixels[off+1], inputPixels[off+2], inputPixels[off+3]]; };
    var O = function (off, p) { outputPixels[off+0] = p[0]; outputPixels[off+1] = p[1]; outputPixels[off+2] = p[2]; outputPixels[off+3] = p[3]; };
