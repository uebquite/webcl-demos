...
window.WebCLCommon = (function(debug){
    ...
    var NO_CONTEXT_CREATED = "Context is null, you must create a context " +
    ...
    var getDevicesPerType = function(type) {
        ...
        for (var i=0; i<devices.length; i++) {
            if (devices[i].getInfo(webcl.DEVICE_TYPE) === type) {
    ...
    return {
         ...
         * platforms and devices. Type can be null, CPU or GPU.
         * 
         */
        init : function(type) {
        ...
        createProgram : function(src) {
            ...
            try {
                if (!context) {
                    throw new Error(NO_CONTEXT_CREATED);
                }
